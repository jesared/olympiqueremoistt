  ...
  const handleDelete = () => {
    startTransition(async () => {
      try {
        ...
        setIsOpen(false);
        showToast({ message: "Catégorie supprimée.", kind: "success" });
      } catch {
        showToast({
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Voulez-vous vraiment supprimer <strong>{categoryName}</strong> ? Les posts
              associés conserveront leur contenu, mais sans catégorie.
            </DialogDescription>
          </DialogHeader>
