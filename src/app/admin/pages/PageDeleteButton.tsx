  ...
  const handleDelete = () => {
    startTransition(async () => {
      try {
        ...
        setIsOpen(false);
        showToast({ message: "Page supprimée.", kind: "success" });
      } catch {
        showToast({
          message: "Impossible de supprimer cette page.",
          kind: "error",
        });
      }
    });
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Voulez-vous vraiment supprimer <strong>{pageTitle}</strong> ? Cette action
              est irréversible.
            </DialogDescription>
          </DialogHeader>
